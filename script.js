const decks = {
  ...
  reading: {
    title: "读书",
    words: [
      { ru: "бегло",   zh: "流利",   py: "liú lì" },
      { ru: "крутой",  zh: "厉害",   py: "lì hai" },
      { ru: "грамматика",     zh: "语法",   py: "yǔ fǎ" },
      { ru: "истинный",     zh: "准确",   py: "zhǔn què" },
      { ru: "слово",     zh: "词语",   py: "cí yǔ" },
      { ru: "даже",     zh: "连",   py: "lián" },
      { ru: "читать про себя",     zh: "阅读",   py: "yuè dú" },
      { ru: "читать вслух",     zh: "朗读",   py: "lǎng dú" },
      { ru: "запутанный",     zh: "复杂",   py: "fù zá" },
      { ru: "придёться (нет другого выбора)",     zh: "只好",   py: "zhǐ hǎo" },
      { ru: "заполнять пропуски",     zh: "填空",   py: "tián kòng" },
      { ru: "угадывать",     zh: "猜",   py: "cāi" },
      { ru: "иначе",     zh: "否则",   py: "fǒu zé" },
      { ru: "гостинная",     zh: "客厅",   py: "kè tīng" },
      { ru: "журнал",     zh: "杂志",   py: "zá zhì" },
      { ru: "газета",     zh: "报纸",   py: "bào zhǐ" },
      { ru: "вне зависимости от",     zh: "无论",   py: "wú lùn" },
      { ru: "известный",     zh: "著名",   py: "zhù míng" },
      { ru: "страница",     zh: "页",   py: "yè" },
      { ru: "увеличиваться (в колличестве)",     zh: "增加",   py: "zēng jiā" }
    ]
  }
};
